...
<html>
  ...
  <body>
    ...
    <s:form  action="DataFunctionH!edited.action" name="dfForm" method="post" onsubmit="return verifyInput();" validate="true">
  	<table>
  	 	<s:if test="message"><h1 style="color:red">修改成功！</h1></s:if>
  		<tr>
  			<td width="15%">数据文件名</td>
  			<td >
  			    <input type="text" name="dataFunction.name" style="width:160px" value="<s:property value='dataFunction.name'/>"> 
  		...
  		<tr>
  			<td> 
  	    		<s:radio  label="估算方法" name="dataFunction.methodType" value="dataFunction.methodType" list="#{'输入DET和RET的范围':'输入DET和RET的范围','手动导入DET和RET':'手动导入DET和RET'}"></s:radio>
  		   </td> 
  		</tr>
  	</table>
