...
详细型：识别数据功能和事务功能过程复杂，最完整" colspan="5">采用的估算方法：<s:property value="countSession.methodType"/></td>
			...
			<tfoot><tr><th scope="row">功能点总数</th>
			<td colspan="4"><s:property value="countSession.ufpc"/>FP</td></tr></tfoot>
			<tbody>
				<tr>
					<s:iterator value="atomFunctionModules"><!-- 原子模块 -->
					<th scope="row" rowspan=<s:property value="2"/>> <s:property value="name"/>(<s:property value="ufpc"/> FP)</th>			
					<tr>
						<td>
