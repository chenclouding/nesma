...
<html>
  ...
  <body>
    ...
    <s:form  action="DataFunctionM!edited.action" name="dfForm" method="post" onsubmit="return verifyInput();" >
  	<table>
  	 	<s:if test="message"><h1 style="color:red">修改成功！</h1></s:if>
  		<tr>
  			<td width="15%">数据文件名</td>
  			<td >
  			    <input type="text" id="name" name="dataFunction.name" style="width:160px" value="<s:property value='dataFunction.name'/>"> 
